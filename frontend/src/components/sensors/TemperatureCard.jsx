...
export default function TemperatureCard({ portNum, reading, status, onChartClick }) {
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          <p className="font-semibold text-slate-900 dark:text-white text-sm">Temperature</p>
      ...
      <div className="rounded-xl bg-slate-100/80 dark:bg-black/20 border border-slate-200 dark:border-white/10 p-3 mt-3 flex-1 flex flex-col justify-center">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="text-right">
            ...
            {value !== null && <p className="text-[11px] text-slate-400 dark:text-gray-500 mt-1">°C</p>}
          </div>
        </div>
      </div>
    </div>
