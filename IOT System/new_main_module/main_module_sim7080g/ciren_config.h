...
#define MQTT_BACKOFF_MIN_MS  10000   // initial reconnect delay after failure
#define MQTT_BACKOFF_MAX_MS  120000  // max reconnect delay (2 min)
...
#define SIM_CATM_BANDS        "1,3,8,18,19,26"